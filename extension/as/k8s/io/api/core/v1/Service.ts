...
export class Service {
  static encode(message: Service, writer: Writer): void {
    ...
    if (spec !== null) {
      writer.uint32(18);
      writer.fork();
      ServiceSpec.encode(spec, writer);
      writer.ldelim();
    }
    ...
    if (status !== null) {
      writer.uint32(26);
      writer.fork();
      ServiceStatus.encode(status, writer);
      writer.ldelim();
    }
  }

  static decode(reader: Reader, length: i32): Service {
  ...
  constructor(
    ...
    spec: ServiceSpec | null = null,
    status: ServiceStatus | null = null
  ) {
