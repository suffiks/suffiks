...
export class ConfigMapEnvSource {
  static encode(message: ConfigMapEnvSource, writer: Writer): void {
  ...
  static decode(reader: Reader, length: i32): ConfigMapEnvSource {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new ConfigMapEnvSource();
