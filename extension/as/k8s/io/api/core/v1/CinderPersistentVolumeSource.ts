...
export class CinderPersistentVolumeSource {
  static encode(message: CinderPersistentVolumeSource, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): CinderPersistentVolumeSource {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new CinderPersistentVolumeSource();
