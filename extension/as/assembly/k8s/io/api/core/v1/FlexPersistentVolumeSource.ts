...
export class FlexPersistentVolumeSource {
  static encode(message: FlexPersistentVolumeSource, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): FlexPersistentVolumeSource {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new FlexPersistentVolumeSource();
