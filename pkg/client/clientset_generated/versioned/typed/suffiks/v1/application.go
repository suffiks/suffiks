...
import (
	...
	v1 "github.com/suffiks/suffiks/base"
	scheme "github.com/suffiks/suffiks/pkg/client/clientset_generated/versioned/scheme"
...
func newApplications(c *SuffiksV1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
