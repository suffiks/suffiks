...
export class ScaleIOVolumeSource {
  static encode(message: ScaleIOVolumeSource, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): ScaleIOVolumeSource {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new ScaleIOVolumeSource();
