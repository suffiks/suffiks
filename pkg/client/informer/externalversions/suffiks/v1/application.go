...
import (
	...
	versioned "github.com/suffiks/suffiks/pkg/client/clientset/versioned"
	internalinterfaces "github.com/suffiks/suffiks/pkg/client/informer/externalversions/internalinterfaces"
	v1 "github.com/suffiks/suffiks/pkg/client/lister/suffiks/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SuffiksV1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SuffiksV1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
		&suffiksv1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&suffiksv1.Application{}, f.defaultInformer)
}
